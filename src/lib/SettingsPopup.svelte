  ...
  {#if isOpen}
    <div class="popup-overlay">
      <div class="popup-content">
        ...
        <input type="color" bind:value={selectedColor} on:change={handleColorChange} />
        <!-- Trash Day Selector -->
        ...
        <p>Currently Selected: {["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][selectedTrashDay]}</p>
